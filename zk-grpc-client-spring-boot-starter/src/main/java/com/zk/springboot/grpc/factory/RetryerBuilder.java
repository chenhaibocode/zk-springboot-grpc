...
import com.zk.springboot.grpc.factory.enums.WaitStrategies;
import com.zk.springboot.grpc.factory.enums.WaitTimeStrategies;
import com.zk.springboot.grpc.factory.impl.ExceptionClassPredicate;
import com.zk.springboot.grpc.factory.impl.ExceptionPredicate;
import com.zk.springboot.grpc.factory.impl.ResultPredicate;
...
public class RetryerBuilder<T> {
    ...
    public RetryerBuilder<T> withDescription(String description) {
        Preconditions.checkState(StringUtils.isEmpty(this.description),
